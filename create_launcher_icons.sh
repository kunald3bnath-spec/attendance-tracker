...
# Resize using sips
sips -z 48 48 "$SRC_IMG" --out app/src/main/res/mipmap-mdpi/ic_launcher.png
sips -z 72 72 "$SRC_IMG" --out app/src/main/res/mipmap-hdpi/ic_launcher.png
sips -z 96 96 "$SRC_IMG" --out app/src/main/res/mipmap-xhdpi/ic_launcher.png
sips -z 144 144 "$SRC_IMG" --out app/src/main/res/mipmap-xxhdpi/ic_launcher.png
sips -z 192 192 "$SRC_IMG" --out app/src/main/res/mipmap-xxxhdpi/ic_launcher.png
sips -z 512 512 "$SRC_IMG" --out app/src/main/res/drawable/ic_launcher_playstore.png
